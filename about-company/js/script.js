...
//Modal window for REST OF PAGES
 function ModalAll() {
     ...
     function closeModalAll(){
         ...
         // filter.style.filter = 'none'; This is working so do not delete. May it be here for the first time
         //Get OFF dark background filter for page
         $('.menu-bar').removeClass('back-grey');
         // filter.style.backgroundColor = 'rgba(0,0,0,0)'; This is working so do not delete. May it be here for the first time
         //Get  scroll ON
